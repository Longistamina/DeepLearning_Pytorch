...
print(torch.sum(tensor_M, dim=0)) # sum across rows
# tensor([ 5.2000,  6.0000,  9.4000, 15.2000])

print(tensor_M.sum(dim=1)) # sum across columns
...
print(torch.mean(tensor_M, dim=0)) # mean across rows
# tensor([2.6000, 3.0000, 4.7000, 7.6000])

print(tensor_M.mean(dim=1)) # mean across columns
...
print(torch.median(tensor_M, dim=0)) # median across rows
# torch.return_types.median(
# values=tensor([2.0000, 1.0000, 4.0000, 6.2000]),
# indices=tensor([0, 1, 0, 1]))

print(tensor_M.median(dim=1)) # median across columns
# torch.return_types.median(
...
print(torch.mode(tensor_M)) # mode across columns by default
# torch.return_types.mode(
# values=tensor([2., 1.]),
# indices=tensor([0, 1]))

print(tensor_M.mode()) # mode across columns by default
# torch.return_types.mode(
# values=tensor([2., 1.]),
# indices=tensor([0, 1]))

print(torch.mode(tensor_M, dim=0)) # mode across rows
# torch.return_types.mode(
# values=tensor([2.0000, 1.0000, 4.0000, 6.2000]),
# indices=tensor([0, 1, 0, 1]))

print(tensor_M.mode(dim=1)) # mode across columns
# torch.return_types.mode(
# values=tensor([2., 1.]),
# indices=tensor([0, 1]))
...
print(torch.var(tensor_M, dim=0)) # var across rows
# tensor([0.7200, 8.0000, 0.9800, 3.9200])

print(tensor_M.var(dim=1)) # var across columns
...
print(torch.std(tensor_M, dim=0)) # std across rows
# tensor([0.8485, 2.8284, 0.9899, 1.9799])

print(tensor_M.std(dim=1)) # std across columns
...
print(torch.min(tensor_M, dim=0)) # min across rows
# torch.return_types.min(
# values=tensor([2.0000, 1.0000, 4.0000, 6.2000]),
# indices=tensor([0, 1, 0, 1]))

print(tensor_M.min(dim=1)) # min across columns
# torch.return_types.min(
# values=tensor([2., 1.]),
# indices=tensor([0, 1]))
...
print(torch.max(tensor_M, dim=0)) # max across rows
# torch.return_types.max(
# values=tensor([3.2000, 5.0000, 5.4000, 9.0000]),
# indices=tensor([1, 0, 1, 0]))

print(tensor_M.max(dim=1)) # max across columns
# torch.return_types.max(
...
print(torch.quantile(tensor_Mb, q=q_vals, dim=0)) # quantile across rows
...
print(torch.quantile(tensor_Mb, q=q_vals, dim=1)) # quantile across columns
